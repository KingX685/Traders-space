  ...
  return (
    <svg viewBox="0 0 512 512" width={size} height={size} style={{ flexShrink: 0 }}>
      <path d="M 370 165 C 370 130, 320 115, 270 130 C 200 150, 145 200, 145 256 C 145 295, 195 320, 256 320 C 317 320, 367 345, 367 384 C 367 420, 320 440, 256 440 C 195 440, 145 425, 130 395"
        fill="none" stroke="#05120e" strokeWidth="48" strokeLinecap="round" strokeLinejoin="round"/>
      <circle cx="370" cy="165" r="22" fill="#05120e"/>
    </svg>
  );
}
      ...
      <header className="lp-nav">
        <div className="lp-nav-inner">
          <a href="/" className="lp-brand">
            <div className="lp-brand-icon"><LandingBrand size={18} /></div>
      ...
      <footer className="lp-footer">
        <div className="lp-container">
          <div className="lp-foot-row">
            <a href="/" className="lp-brand">
              <div className="lp-brand-icon"><LandingBrand size={16} /></div>
              <span>TRADERS SPACE</span>
            </a>
          ...
          <div className="lp-foot-bottom">
            <span>© {new Date().getFullYear()} Traders Space · Built for traders, by a trader.</span>
          </div>
        </div>
      </footer>
